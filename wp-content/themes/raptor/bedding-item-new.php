...
if ($collectionsPage) {
    $pillows    = !empty(get_field('pillows')) ? get_field('pillows') : [];
    $protectors = !empty(get_field('protectors')) ? get_field('protectors') : [];
    $quits      = !empty(get_field('quits')) ? get_field('quits') : [];
    $sheets     = !empty(get_field('sheets')) ? get_field('sheets') : [];
    $posts = array_merge($pillows, $protectors, $quits, $sheets);
}
?>
                            ...
                            <?php if(!empty($posts)) : ?>
                                <?php foreach ($posts as $post) : ?>
                                    ...
                                    <div class="accessories-card">
                                        ...
                                        <div class="accessories-card__title"><?= get_the_title($post->ID); ?></div>
                                        <div class="accessories-card__text">
                                            <p><?= get_the_excerpt($post->ID) ?></p>
                                        </div>
                                        <div class="accessories-card__footer"><a class="under-link js-modal-open" href="#" data-modal-id="modal-html" data-modal-html="#accessories-<?= $post->ID ?>">SEE MORE</a>
                                        </div>
                                        <div class="get-content" id="accessories-<?= $post->ID ?>" style="display:none; visibility: hidden;">
                                                ...
                                                <div class="modal-info">
                                                    <div class="modal-info__text">
                                                        ...
                                                        <div class="content">
                                                            ...
                                                            <?php $details = get_field('accessories_details', $post->ID);?>
                                                            <ul>
