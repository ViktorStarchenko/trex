        ...
        var Component_FormFloatLabel = (function (_Abstract2) {
            ...
            _createClass(Component_FormFloatLabel, [{
                ...
                value: function bindEvents() {
                    ...
                    this.$el.on('floatLabel:reinit', function () {
                        console.log("floatLabel:reinit bindevent");
                        _this.initialise();
                    });
                }
            }, {
            ...
            _createClass(Component_Hero, [{
                ...
                value: function initialiseListeners() {
                    ...
                    if (jQuery(this.coverVideo).length > 0) {
                        ...
                        jQuery('.covervid-video').on("timeupdate", function () {
                            ...
                            console.log('timeupdate listener');
                ...
                value: function firstLoad() {
                    ...
                    jQuery(this.$el).imagesLoaded().done(function (instance) {
                        console.log('hero images successfully loaded');
        ...
        var Component_IntroLoadImages = (function (_Abstract2) {
            ...
            _createClass(Component_IntroLoadImages, [{
                ...
                value: function scrollMagicScenes() {
                    ...
                    this.scene1 = new ScrollMagic.Scene({ triggerElement: "#layer01", duration: "100%" }).on("enter", function (event) {
                    ...
                    this.scene5 = new ScrollMagic.Scene({ triggerElement: "#technology" }).on("enter leave", function (event) {
                        ...
                        if (event.type == 'enter') {
                            ...
                            clickpointsTL.to(
                                ...
                                0.5, { opacity: 1 }, "-=0.25").to(".m-technology__clickpoints .-point02", 0.5, { opacity: 1 }, "-=0.25").to(".m-technology__clickpoints .-point03", 0.5, { opacity: 1 }, "-=0.25").to(".m-technology__clickpoints .-point04", 0.5, { opacity: 1 }, "-=0.25").to(".m-technology__clickpoints .-point05", 0.5, { opacity: 1 }, "-=0.25").to(".m-technology__clickpoints .-point06", 0.5, { opacity: 1 }, "-=0.25");
	...
	/***/ function(module, exports, __webpack_require__) {
        ...
        var FixedImage = (function () {
            ...
            _createClass(FixedImage, [{
                ...
                key: 'resetStyle',
                value: function onResizing(currentNum) {
                ...
                value: function zoomStyle(currentNum) {
                    ...
                    var sceneXPos = [178, 61, 146];
                    var sceneYPos = [21, 155, 107];
                    var sceneScale = [3.2, 2.9, 2.9];
